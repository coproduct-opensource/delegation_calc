...
-- a later increment).
lean_lib «DLCD» where
  roots := #[`DLCD.Rsm, `DLCD.FaultGrade, `DLCD.CapSafety, `DLCD.CapSafetyLinear, `DLCD.Consensus, `DLCD.ByzantineConsensus, `DLCD.MultiDecree, `DLCD.ByzantineMultiDecree, `DLCD.MultiDecreeLiveness, `DLCD.Liveness, `DLCD.Termination, `DLCD.Linearizable, `DLCD.Witness, `DLCD.LabelFlow, `DLCD.Calm, `DLCD.DistributedNI, `DLCD.TypedLog, `DLCD.Summary]
