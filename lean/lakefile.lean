...
-- a later increment).
lean_lib «DLCD» where
  roots := #[`DLCD.Rsm, `DLCD.CapSafety, `DLCD.Consensus, `DLCD.Liveness, `DLCD.Termination, `DLCD.Linearizable, `DLCD.Witness, `DLCD.LabelFlow, `DLCD.Calm, `DLCD.DistributedNI]
