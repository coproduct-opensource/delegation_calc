...
Rust wire-format implementation with round-trip-tested encoding.
Of the four headline theorems: T1 (decidability) is proven for the
propositional fragment; T2's (cryptographic correspondence) proven
content is the axiom-free symbolic characterization---cryptographic
typing coincides with logical typing plus signature validity; T3
(non-interference) and T4 (obligation soundness) are stated only,
with their gaps documented rather than papered over.
