...
contribution is occupying the decidability sweet-spot: the modal
fragment we use admits a structural checker (T1) at $O(|M| \cdot \log |\Gamma|)$,
making browser-side verification practical.
...
\texttt{act} claim for delegation chains.  The March 2026 IETF OAuth
mailing-list thread on chain splicing~\cite{ietf2026splicing}
